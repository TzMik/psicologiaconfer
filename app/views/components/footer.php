<footer class="py-4">
    <div class="container">
        <div class="row mb-4">
            <div class="col-md-6">
                <h2 class="h4 text-primary">Psicóloga Fernanda Quiroga</h2>
        ...
        <hr>
        <div class="text-center text-muted">Copyright © <?= date('Y') ?>. Fernanda Quiroga. Todos los derechos reservados.</div>
    </div>
</footer>
